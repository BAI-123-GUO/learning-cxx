...
int main(int argc, char **argv) {
    {
        ...
        ASSERT(arr.size() == sizeof(int[5])/sizeof(int), "Fill in the correct value.");
    ...
    }
    {
        ...
        ASSERT(arr.size() == sizeof(double[8])/sizeof(double), "Fill in the correct value.");
        ASSERT(sizeof(arr) == sizeof(double[8]), "Fill in the correct value.");
    }
    {
        std::array<char, 21> arr{"Hello, InfiniTensor!"};
        ASSERT(arr.size() == sizeof(char[21])/sizeof(char), "Fill in the correct value.");
